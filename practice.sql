...
SELECT department_name , ROUND(AVG(salary)) FROM employees AS e
...
-- Find the department name with heigest average salray
...
SELECT customer_id, SUM(total_amount), COUNT(*) FROM orders
